...
Usage:
 ...
 friendly = get_friendly_name("fecal_coliform_per_00ml")
...
COLUMN_MAPPING = {
 ...
 "fecal_coliform_per_00ml": "Fecal Bacteria Count",
 "total_coliform_per_00ml": "Total Bacteria Count",
...
def get_friendly_name(column_name: str) -> str:
 ...
 Args:
 column_name: The technical column name (e.g., "fecal_coliform_per_00ml")
 ...
 Examples:
 >>> get_friendly_name("fecal_coliform_per_00ml")
